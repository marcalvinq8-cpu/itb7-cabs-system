...
const statusMap = {
  ...
  cancelled:         'bg-[#F2F3F4] text-[#717D7E] border-[#E5E7E9]',
  paid:              'bg-[#EAFAF1] text-[#1E8449] border-[#A9DFBF]',
  failed:            'bg-[#FADBD8] text-[#96281B] border-[#F1948A]',
  expired:           'bg-[#F2F3F4] text-[#717D7E] border-[#E5E7E9]',
  ...
  closed:            'bg-[#F2F3F4] text-[#717D7E] border-[#E5E7E9]',
  administrator:     'bg-[#E8DAEF] text-[#6C3483] border-[#C39BD3]',
  staff:             'bg-[#D6EAF8] text-[#1A5276] border-[#AED6F1]',
  client:            'bg-[#F2F3F4] text-[#717D7E] border-[#E5E7E9]',
}
const labels = { under_maintenance: 'Maintenance' }

export default function Badge({ status, className }) {
  const style = statusMap[status] ?? 'bg-[#F2F3F4] text-[#717D7E] border-[#E5E7E9]'
